...
6. 一時保存用フォルダに保存したログを S3 に送信する
7. 一時保存用フォルダに保存したログを S3 に送信したことについてイベントログ(Applicationログ)にメッセージを出力する
8. 一時保存用フォルダに保存した対象のログを削除する
9. 一時保存用フォルダに保存した対象のログを削除したことについてイベントログ(Applicationログ)にメッセージを出力する
10. イベントログ(Applicationログ)に終了メッセージを出力する
